...
Urban land is fixed exogenously in each simulation year, using the LUH2-consistent base-year level and SSP-specific future change from the SEDAC urban dataset.
